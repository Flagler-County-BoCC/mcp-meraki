Call the `get-organization-uplinks-statuses` tool from meraki-dashboard-api.

List the uplink status of every Meraki MX, MG and Z series devices in the organization (read-only GET).
