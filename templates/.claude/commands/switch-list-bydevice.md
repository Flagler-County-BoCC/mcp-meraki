Call the `switch-list-bydevice` tool from meraki-dashboard-api.

List most recently seen LLDP/CDP discovery and topology information per switch port in an organization. (read-only GET).
...
- perPage: integer — The number of entries per page returned. Acceptable range is 3 - 20. Default is 10. (optional)
